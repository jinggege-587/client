    ...
    <div class="page-wrap">
      ...
      <div class="page-content">
        ...
        <div style="margin: 10px 0;text-align: center; font-size: 12px;">
          <div style="">
            <input style="margin: 1px 0;width: 15px;height:15px;" type="checkbox" v-model="loginForm.validate"><span style="vertical-align: top;color: #888;">注册或使用网站账号登录即视为您已同意</span>
          </div>
