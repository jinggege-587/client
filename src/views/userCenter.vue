        ...
        <div class="userCenter-head">
          ...
          <template v-else>
            <router-link tag="div" style="width: 100%;height: 100%;" :to="{name: 'login'}">
              ...
              <div style="height: 50%; background-color: #ffffff; text-align: center;">
                <p style="padding-top: 5%;">登录</p>
              </div>
            </router-link>
          </template>
        </div>
        <div class="userCenter-charge">
          <a @click.stop="toRecharge">
            <mt-cell title="我的财产" is-link>
              <span>{{$global.showPay ? '去充值' : ''}}</span>
