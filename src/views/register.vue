    ...
    <div class="page-wrap">
      ...
      <div class="page-content">
        ...
        <div style="margin: 10px 0;text-align: center; font-size: 12px;">
          <div style="">
            <input style="margin: 1px 0;width: 15px;height:15px;" type="checkbox" v-model="registerData.agreement"><span style="vertical-align: top;color: #888;">注册或使用网站账号登录即视为您已同意</span>
          </div>
    ...
    validateField (field, scope) {
      ...
      switch (field) {
        ...
        case 'pwd':
          ...
          break
        case 'pwd2':
          if (!scope.pwd2.trim() || scope.pwd2 !== scope.pwd) {
            this.toast('两次密码不一致')
            valid = false
          }
          break
